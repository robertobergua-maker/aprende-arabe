...
// --- DATOS COMPLETOS DEL PDF (1A2 PRÁCTICA ORAL) ---
const INITIAL_DATA = [
  // Pista 1: Saludos
...
  { id: 302, category: "Pista 3: ¿Cómo estás?", spanish: "Bien (Gracias a Dios)", arabic: "بخير والحمد لله", phonetic: "Bikhayr wal-hamdulillah" },
  { id: 303, category: "Pista 3: ¿Cómo estás?", spanish: "Regular / No está mal", arabic: "لا بأس", phonetic: "La ba's" },

  // Pista 4: Pronombres personales
  { id: 401, category: "Pista 4: Pronombres", spanish: "Yo", arabic: "أنا", phonetic: "Ana" },
  { id: 402, category: "Pista 4: Pronombres", spanish: "Tú (masculino)", arabic: "أنت", phonetic: "Anta" },
  { id: 403, category: "Pista 4: Pronombres", spanish: "Tú (femenino)", arabic: "أنت", phonetic: "Anti" },
  { id: 404, category: "Pista 4: Pronombres", spanish: "Él", arabic: "هو", phonetic: "Huwa" },
  { id: 405, category: "Pista 4: Pronombres", spanish: "Ella", arabic: "هي", phonetic: "Hiya" },
  { id: 406, category: "Pista 4: Pronombres", spanish: "Nosotros", arabic: "نحن", phonetic: "Nahnu" },
  { id: 407, category: "Pista 4: Pronombres", spanish: "Vosotros", arabic: "أنتم", phonetic: "Antum" },
  { id: 408, category: "Pista 4: Pronombres", spanish: "Ellos", arabic: "هم", phonetic: "Hum" },

  // Pista 6: De dónde eres
  { id: 601, category: "Pista 6: Origen", spanish: "¿De dónde eres?", arabic: "من أين أنت؟", phonetic: "Min ayna anta?" },
  { id: 602, category: "Pista 6: Origen", spanish: "Soy de España", arabic: "أنا من إسبانيا", phonetic: "Ana min Isbania" },
  { id: 603, category: "Pista 6: Origen", spanish: "Soy español", arabic: "أنا إسباني", phonetic: "Ana isbani" },
  { id: 604, category: "Pista 6: Origen", spanish: "Soy francesa", arabic: "أنا فرنسية", phonetic: "Ana faransiya" },
...
  { id: 801, category: "Pista 8: Demostrativos", spanish: "Esto / Este", arabic: "هذا", phonetic: "Hadha" },
  { id: 802, category: "Pista 8: Demostrativos", spanish: "Esta", arabic: "هذه", phonetic: "Hadhihi" },
  { id: 803, category: "Pista 8: Demostrativos", spanish: "¿Qué es esto?", arabic: "ما هذا ؟", phonetic: "Ma hadha?" },
  { id: 804, category: "Pista 8: Demostrativos", spanish: "Esto es un libro", arabic: "هذا كتاب", phonetic: "Hadha kitab" },
  
  // Pista 20: La Casa
...
    // IMPORTANTE: Si ya existían datos en localStorage, esto prevalece.
    // Para ver los nuevos datos del PDF, limpiamos localStorage si es la versión antigua,
    // o simplemente usamos los datos iniciales si no hay nada guardado.
    const saved = localStorage.getItem('flashcards-data-v2');
...
    // Ordenar categorías alfabéticamente para que las Pistas salgan en orden (1, 2, 20, 30...)
    // Una ordenación natural ayuda con los números
...
      const matchesSearch = 
        card.spanish.toLowerCase().includes(searchTerm.toLowerCase()) ||
        card.arabic.includes(searchTerm) ||
        card.phonetic.toLowerCase().includes(searchTerm.toLowerCase());
      
...
  // --- EFECTOS ---
  useEffect(() => {
    // Usamos una nueva clave 'v2' para evitar conflictos con datos antiguos
    localStorage.setItem('flashcards-data-v2', JSON.stringify(cards));
  }, [cards]);
...
    // Combinar con las tarjetas existentes
    // Generar IDs únicos para las nuevas si no los tienen o si colisionan
...
                    setShowMobileSidebar(false); // Cerrar sidebar en móvil al seleccionar
                  }}
...
    } else {
      console.warn("Usando voz por defecto (posiblemente no árabe).");
      utterance.lang = 'ar-SA';
    }

    utterance.rate = 0.8; // Velocidad lenta para estudiantes
...
      
      // Normalizar: Si es un objeto único, convertirlo en array
      let items = Array.isArray(parsed) ? parsed : [parsed];

      // Validar estructura básica
      if (items.length === 0) throw new Error("La lista está vacía.");
      
      const isValid = items.every(item => item.spanish && item.arabic);
      if (!isValid) throw new Error("Las tarjetas deben tener al menos 'spanish' y 'arabic'.");

      onImport(items);
    } catch (err) {
      setError("Formato inválido. Asegúrate de copiar el bloque JSON completo (incluyendo corchetes [] o llaves {}). Detalles: " + err.message);
    }
  };
...
            Pega aquí el código <strong>JSON</strong> que te ha generado la IA. Puede ser una lista de muchas palabras o una sola.
          </p>
