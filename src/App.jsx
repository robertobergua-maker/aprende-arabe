    ...
    <div className="min-h-screen bg-slate-100 text-slate-800 font-sans flex flex-col">
      ...
      <header className="bg-emerald-700 text-white shadow-md z-20">
        <div className="w-full px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          {/* Contenedor Central de Controles (Buscador + Desplegable + Botones) */}
          <div className="flex-1 w-full max-w-4xl flex flex-col md:flex-row gap-3">
            ...
            {/* DESPLEGABLE DE TEMAS (NUEVO) */}
            <div className="relative md:w-64">
                <Filter className="absolute left-3 top-2.5 w-4 h-4 text-emerald-200 pointer-events-none" />
                <select
                    value={selectedCategory}
                    onChange={(e) => setSelectedCategory(e.target.value)}
                    className="w-full pl-9 pr-8 py-2 bg-emerald-800/50 border border-emerald-600/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400 text-sm text-white appearance-none cursor-pointer hover:bg-emerald-800/70 transition-colors"
                >
                    {categories.map(cat => (
                ...
                <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none text-emerald-200">
            ...
            {/* BOTONES DE CONTROL (Idioma + Signos) */}
            <div className="flex items-center gap-2 bg-emerald-800/50 rounded-lg p-1 border border-emerald-600/30 self-start md:self-auto">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-emerald-800/50 hover:bg-emerald-800 px-3 py-2 rounded-lg text-sm font-medium transition shadow-sm whitespace-nowrap border border-emerald-600/30 self-end md:self-auto"
          >
